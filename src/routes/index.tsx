...
function WelcomeModal() {
  ...
  return (
    <Dialog open={open} onOpenChange={(next) => {
      ...
      <DialogContent
        className="theme-light fixed left-1/2 top-1/2 max-h-[75dvh] w-[84vw] max-w-md -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-2xl border border-[var(--border-subtle)] bg-white p-0 shadow-[0_24px_70px_-24px_rgba(15,23,42,0.25)] !duration-0 data-[state=open]:!animate-none data-[state=closed]:!animate-none sm:max-h-[85dvh] sm:w-[92vw]"
      >
