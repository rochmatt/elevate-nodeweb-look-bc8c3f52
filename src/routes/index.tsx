...
function Home() {
  return (
    <div className="theme-light min-h-screen overflow-x-clip">
      <Nav />
      <InfoTicker />
      <QuickMenu />
      <Hero />
...
function InfoTicker() {
  return (
    <div className="relative z-40 px-3 pt-3 sm:px-6">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-[var(--accent-tint)] py-2 shadow-sm">
        <div className="top-ticker-track flex w-max items-center gap-5 px-3 text-xs font-medium text-[var(--accent-strong)] sm:gap-6 sm:px-4">
...
function QuickMenu() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-2 sm:px-6">
        <Sheet open={open} onOpenChange={setOpen}>
          <SheetTrigger asChild>
            <button
              type="button"
              className="flex w-full items-center justify-between gap-3 rounded-2xl border border-[var(--border-subtle)] bg-white/90 px-4 py-3 text-left shadow-[0_2px_10px_-4px_rgba(15,23,42,0.06)] transition-all duration-300 ease-out hover:border-[var(--accent)]/35 hover:bg-white hover:shadow-[0_8px_24px_-12px_var(--accent-ring)] active:scale-[0.99]"
            >
...
function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 pb-4 pt-4 sm:px-6 sm:pt-14 lg:grid-cols-[1.15fr_1fr] lg:gap-14 lg:pb-32 lg:pt-24">
    ...
    <section id="marketplace" className="relative">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-12 md:py-14">
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
          ...
          <Link
            to="/marketplace"
            className="inline-flex shrink-0 items-center gap-1.5 self-start text-sm font-semibold text-[var(--accent)] transition-all hover:gap-2.5 sm:self-auto"
          >
            Browse all <ArrowRight className="h-4 w-4" />
          </Link>
        </div>

        <div className="-mx-4 mt-6 px-4 sm:mx-0 sm:mt-8 sm:px-0">
        ...
        <div
          ...
          className="mt-7 grid gap-4 sm:mt-9 sm:grid-cols-2 sm:gap-5 lg:grid-cols-4"
        >
          {packages.map((p) => (
